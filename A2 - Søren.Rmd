...
p_load(dagitty, tidyverse, rethinking, brms)
...
d %>% 
  ...
  summarise(meanAlIn = mean(AltercentricIntrusion),
            ...
            sdMR = sd(MindReading),
            meanAlIn = mean(AltercentricIntrusion),
            sdAlIn = sd(AltercentricIntrusion))
...
# Intercept
ACI_f0 <- bf(Diagnosis ~ 1)

# First model
ACI_f1 <- bf(Diagnosis ~ 1 + AltercentricIntrusion)
