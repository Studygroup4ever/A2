...
# Building models
ACI_f0 <- bf(ACI ~ Diagnosis) # Is this how you would use index variables in brm? How do you interprete the outcome?

# First model
#ACI_f1 <- bf(ACI ~ (1|Diagnosis))

# No intercept model
#ACI_f2 <- bf(ACI ~ -1 + Diagnosis)
...
# )
# 
# p1 <- pp_check(ACI_m1_prior, nsamples = 100)
# p2 <- pp_check(ACI_m1, nsamples = 100)
# p1 + p2
...
ggplot(posterior_m0) +
  ...
  geom_vline(xintercept = mean(posterior_m0$b_Diagnosis), lty=2, alpha = .7, color = 'darkblue')
