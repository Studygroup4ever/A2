...
ggplot(posterior_m0) +
  ...
  geom_vline(xintercept = mean(posterior_m0$b_Intercept), lty=2, alpha = .7, color = 'darkblue')
...
hypothesis(ACI_m0, "Diagnosis > 0") # what dis function?
hypothesis(ACI_m0, "Intercept < 0")
```
