...
```{r}
# for model APA
hypothesis(modelAPA, "APA > 0")
hypothesis(modelAPA, "APA < 0")
hypothesis(modelAPA, "APA = 0")

# for model VH
hypothesis(modelVH, "VH > 0")
hypothesis(modelVH, "VH < 0")
hypothesis(modelVH, "VH = 0")

# for model MR
hypothesis(modelMR, "MR > 0")
hypothesis(modelMR, "MR < 0")
hypothesis(modelMR, "MR = 0")

# for model with MR and VH
hypothesis(model_mTwo, "MR > 0")
hypothesis(model_mTwo, "MR < 0")
hypothesis(model_mTwo, "MR = 0")

hypothesis(model_mTwo, "VH > 0")
hypothesis(model_mTwo, "VH < 0")
hypothesis(model_mTwo, "VH = 0")

# for model with all symptoms 
hypothesis(model4, "MR > 0")
hypothesis(model4, "MR < 0")
hypothesis(model4, "MR = 0")

hypothesis(model4, "VH > 0")
hypothesis(model4, "VH < 0")
hypothesis(model4, "VH = 0")

hypothesis(model4, "APA > 0")
hypothesis(model4, "APA < 0")
hypothesis(model4, "APA = 0")
